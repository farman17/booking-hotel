...
<html lang="en">
    <head>
        ...
        <title>Pembayaran Kebersihan</title>
    ...
    <body>
        <header>
            <nav class="top-nav">
                <div class="container">
                    <div class="nav-wrapper">
                        <a class="page-title">Pembayaran Kebersihan</a>
                    </div>
                </div>
            </nav>
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <?php echo form_open_multipart('admin/pembayaran-kebersihan') ?>
                        <table>
                            <tr>
                                <td><b>NO ID PEMBAYARAN</b></td>
                                <td>:</td>
                                <td>
                                    <input required name="no_id" type="text" class="validate">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <select name="nama_perawatan">
                                        <option value"Pembayaran Kebersihan">Pembayaran Kebersihan</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php foreach($gedung as $row): ?>    
                                        <option value="<?php echo $row['NAMA_GEDUNG']?>"><?php echo $row['NAMA_GEDUNG']?></option>
                                    <?php endforeach; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input name="tanggal_pembayaran" type="date" class="validate">
                                </td>
                            </tr>
                            <tr>
                                <td><b>BIAYA</b></td>
                                <td>:</td>
                                <td>
                                    <input required name="biaya" type="text" class="validate">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="file-field input-field">
                                        ...
                                        <input class="file-path validate" type="text" placeholder="Max Size 800 kb With Max Dimension 1000x1000">
                                        </div>
                                    </div>
                                </td>
                            </tr>
