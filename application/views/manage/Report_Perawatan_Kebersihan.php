...
<html lang="en">
    <head>
        ...
        <title>Laporan Perawatan Kebersihan</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m12">
                        <center><h5><b>Laporan Pembayaran Kebersihan</b></h5></center>
                        ...
                        <table style="display: inline-block;">
                            <tr>
                                <td><b>Total Pembayaran Kebersihan: </b></td>
                                <td><b><?php echo "Rp. ".number_format($total_pembayaran) ?></b></td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="<?php echo site_url('manage/kebersihan_download_pdf') ?>">Ekspor ke PDF</a>
                                </td>
                            </tr>
                        </table>
                    </div>
